    ...
    sort(sortable, comparator) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                yield this.mergeSort(sortable, comparator, 0, sortable.size() - 1);
                resolve(sortable);
            }));
        });
    }
    mergeSort(sortable, comparator, start, end) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (size < 1) {
                    ...
                    if (comparator.compare(yield sortable.get(start), yield sortable.get(end)) === Comparison_1.default.RIGHT) {
                        yield sortable.switch(start, end);
                    }
                    resolve(sortable);
                    return;
                }
                let half = Math.floor(size / 2) + start;
                yield this.mergeSort(sortable, comparator, start, half - 1);
                yield this.mergeSort(sortable, comparator, half, end);
